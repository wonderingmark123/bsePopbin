...
*
      ...
      real*8 tb,ecc,yearsc,sep,CG,Rsun,Mtotal
...
*
      ...
      READ(22,*)mass0(1),mass0(2),tphysf,sep,kstar(1),kstar(2),z,ecc
...
*
      Rsun = 6.96e8
      CG= 6.67e-11
      Mtotal = 1.99e30*(mass0(1)+mass0(2))
...
* Set parameters which depend on the metallicity 
       write(*,*)'mass0(1),mass0(2),a',mass0(1),mass0(2),sep,tb
*
      CALL zcnsts(z,zpars)
*
