...
***************************************************************
        ...
        PARAMETER(M1max=150,M2max=80,M1min=5,M2min=0.1,
     &            amax=10000,amin=3)
...
*
      ...
      OPEN(12,file='all_Lx37erg_z0.01_wind_ser.out',status='unknown')
      OPEN(13,file='all_Lx37erg_z0.01_rb_ser.out',status='unknown')
      OPEN(14,file='first_Lx37erg_z0.01_wind_ser.out',status='unknown')
      OPEN(15,file='first_Lx37erg_z0.01_rb_ser.out',status='unknown')
*
      do i = 1,nm1
...
*
     ...
     &bcm(jj,i1).gt.0.0.and.kw.gt.2.and.bcm(jj,31).gt.0)then
