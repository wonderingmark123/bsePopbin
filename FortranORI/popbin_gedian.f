...
*
      ...
      OPEN(12,file='all_Lx37erg_z0.01_wind_gedian.out',status='unknown')
      OPEN(13,file='all_Lx37erg_z0.01_rb_gedian.out',status='unknown')
      OPEN(14,file='first_Lx37erg_z0.01_wind_gedian.out',status='unknown')
      OPEN(15,file='first_Lx37erg_z0.01_rb_gedian.out',status='unknown')
*     
            i=0
...
!             call random_number(bb)
            ...
            !  call random_number(cc)
             ...
             mass02=mass0(2)
             write(Ctemp,"(I10)") i
            OPEN(16,file='DataGedianz0.01\'//trim(adjustl(Ctemp))//'.out'
     &            ,status='unknown')
...
* 检测最后一行
         ...
         WRITE(16,99)bcm(jj,1),INT(bcm(jj,2)),INT(bcm(jj,16))
...
*
     ...
     &  ,tb0,mt1,mt2,kw,kw2,mx,mx2,eccx,tbx,f,m_transferrate,uuu,m_tr,i
                                          anotherloop=0
                                    endif
...
*
 ...
 113  FORMAT(2f25.5,e30.6,5f30.6,2i5,5f25.6,3e30.6,1i3)
      CLOSE(10)
      CLOSE(11)
      CLOSE(12)
*
