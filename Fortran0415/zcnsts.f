...
!----------------------------------------------------------------------
!
!             15-18; coefficients for low-mass HG and RGB core radii
*       ------------------------------------------------------------
*
      lzs = log10(z/0.02d0)
...
!     Section 3.1.1 & Appendix A, Table A1,
!     for calculating core radii of low-mass HG and RGB stars
!     (zpars(15+i) == c_i) in eqn.A1
!
      zpars(15) = +2.817859d+0
     &     + lzs*(+4.331671d-1
     &     + lzs*(-8.152041d-1
     &     + lzs*(-1.329429d+0
     &     + lzs*(-3.502317d-1))))
      zpars(16) = -1.454750d+1
     &     + lzs*(-3.844703d+0
     &     + lzs*(+8.279414d+0
     &     + lzs*(+1.252224d+1
     &     + lzs*(+3.256815d+0))))
      zpars(17) = +4.947425d+1
     &     + lzs*(+1.369688d+1
     &     + lzs*(-2.513380d+1
     &     + lzs*(-3.773333d+1
     &     + lzs*(-9.791961d+0))))
      zpars(18) = -4.914713d+1
     &     + lzs*(-1.326969d+1
     &     + lzs*(+4.137217d+1
     &     + lzs*(+6.525871d+1
     &     + lzs*(+2.617208d+1
