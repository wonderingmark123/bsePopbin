...
*
     ...
     &            R1,L1,KW1,MC1,RC1,MENV,RENV,K21)
      ...
      !  write(*,*)'mass01,mass02',mass01,mass02
      !  write(*,*)'KW1,Z,M01,M1,MC1,L1,R1',KW1,Z,M01,M1,MC1,L1,R1
      EBINDI = CEEBINDF(KW1,Z,M01,M1,MC1,L1,R1,MENV,LAMBDA)
      KW = KW2
...
*
      ...
      !  write(*,*)'mass01,mass02',mass01,mass02
      !  write(*,*)'KW2,Z,M02,M2,MC2,L2,R2',KW2,Z,M02,M2,MC2,L2,R2
         EBINDI = EBINDI + CEEBINDF(KW2,Z,M02,M2,MC2,L2,R2,MENV,LAMBDA)
*
